...
class GoogleCSVReader(IDataReader):
    """Infrastructure implementation of IDataReader for Google Ads CSV files.
    ...
    def read(self, file_path: str) -> list[dict[str, object]]:
        """Reads raw Google Ads records from a CSV file.
        ...
        # Validate presence of required column groups
